...
class AuthProvider {
    ...
    //SignUp function
    func signUp(withEmail: String, name: String, surname: String, carType: String, contact: String, profileimageURL: String, password: String, loginHandler: LoginHandler?) {
        ...
        Auth.auth().createUser(withEmail: withEmail, password: password, completion: { (user, error) in
            ...
            if error != nil {
                ...
                if user != nil {
                    ...
                    DBProvider.Instance.saveUser(withID: userID, email: withEmail, name: name, surname: surname, carType: carType, contact: contact, profileimageURL: profileimageURL, password: password)
